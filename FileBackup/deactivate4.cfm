...
<table border="#tblwidth#">
	...
	<tr>
		<cfif DeactWhen Is "Now">
			<td bgcolor="#tbclr#">You have selected to deactivate #GetName.FirstName# #GetName.LastName#.</td>
		<cfelseif DeactWhen Is "Later">
			<td bgcolor="#tbclr#">You are scheduling #GetName.FirstName# #GetName.LastName# to be deactivated #LSDateFormat(WhenRun, '#DateMask1#')#.</td>
		</cfif>
	</tr>
	<cfif SubStatus Is "All">
		<tr>
			<td bgcolor="#tbclr#">You have selected to deactivate all the subaccounts.</td>
		</tr>
	</cfif>
	...
	<tr>
		<td bgcolor="#tbclr#">Click Deactivate Account to confirm.</td>
	</tr>
	<form method="post" action="deactivate5.cfm?RequestTimeout=300">
		<tr>
			<th><input type="image" src="images/custinf11.gif" name="Confirm" border="0"></th>
		</tr>
		<input type="hidden" name="AccountID" value="#AccountID#">
		<input type="Hidden" name="DeactWhen" value="#DeactWhen#">
		<input type="Hidden" name="WhenRun" value="#WhenRun#">
