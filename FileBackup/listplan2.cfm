			...
			<table border="1">
				<form method="post" action="listplan2.cfm">
					...
					<tr>
						...
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 5>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is 5>checked</cfif> name="tab" value="5" onclick="submit()" id="tab5"><label for="tab5">Staff</label></th>
						<cfelse>
