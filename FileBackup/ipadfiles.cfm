...
It was rescheduled for #DateFormat(NewDate, '#DateMask1#')# #TimeFormat(NewDate, 'hh:mm tt')#.
</cfmail>
		<cfelse>
...
<cfelseif IPADType Is "EMail">
	...
	<cfloop query="getIPADmail">
		<cfset IPADfile2 = IPADfile2 & "#cmd1# #Alias_Mask# #DNS_Mask# #UserName# #pswd# #mailbox# #limit1#
">
	</cfloop>
