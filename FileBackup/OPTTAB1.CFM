...
<cfoutput>
	...
	<tr valign="top">
		<td align="right" bgcolor="#tbclr#">Page Access Logging</td>
		<td colspan="2" bgcolor="#tdclr#">
		<input type="Radio" <cfif BOBPHistory.AutoLoadYN Is 0>checked</cfif> name="NoBOBPHist" value="1"> Yes 
		<input type="Radio" <cfif BOBPHistory.AutoLoadYN Is 1>checked</cfif> name="NoBOBPHist" value="0"> No</td>
	</tr>
	<tr valign="top">
		<td align="right" bgcolor="#tbclr#">gBill Event Logging</td>
		<td colspan="2" bgcolor="#tdclr#">
		<input type="Radio" <cfif BOBHistory.AutoLoadYN Is 0>checked</cfif> name="NoBOBHist" value="1"> Yes 
		<input type="Radio" <cfif BOBHistory.AutoLoadYN Is 1>checked</cfif> name="NoBOBHist" value="0"> No</td>
	</tr>
	<tr valign="top">
