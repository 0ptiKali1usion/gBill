...
<cfif IsDefined("DelContact.x")>
	<cfquery name="ContactInfo" datasource="#pds#">
		SELECT EMail, AccountID, FirstName, LastName 
		FROM AccountsEMail 
	...
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="BOBHist" datasource="#pds#">
			...
			(Null,#ContactInfo.AccountID#,#MyAdminID#, #Now()#,'Edited Customer Info',
			 '#StaffMemberName.FirstName# #StaffMemberName.LastName# deleted the contact email address: #ContactInfo.EMail# for #ContactInfo.FirstName# #ContactInfo.LastName#.')
		</cfquery>
	</cfif>
	<cfset Tab = 4>
