...
<!--- 4.0.1 01/31/01 Added Session Name and Compression Level to Secure CRT setup.
		4.0.0 06/19/99 --->
<!--- integration2.cfm --->
...
<cfif IsDefined("TelnetScriptEdit.x")>
	<cfquery name="EditScript" datasource="#pds#">
		...
		TelSessName = <cfif Trim(TelSessName) Is "">Null<cfelse>'#TelSessName#'</cfif>, 
		TelCompLevel = <cfif Trim(TelCompLevel) Is "">Null<cfelse>'#TelCompLevel#'</cfif>, 
