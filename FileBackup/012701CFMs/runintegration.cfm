...
">
					...
					<cfelseif TypeID Is "4">
						...
						<cfloop query="GetOther">
							<cfset IPADOut = IPADOut & "#CMD1# #Alias_Mask# #DNS_Mask# #UserName# #PSWD# #Mailbox# #MailBoxLimit#
">
						</cfloop>
...
">
				...
				<cfelse>
					<cffile action="Write" file="#File2#" output="[#MyOutput#]
