			...
			<table border="1">
				<tr>
					<form method="post" action="pops2.cfm">
						...
						<cfelse>
							<th bgcolor=<cfif tab Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is 2>checked</cfif> name="tab" value="2" onclick="submit()" id="tab2"><label for="tab2">Tax Information</label></th>
							<th bgcolor=<cfif tab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is 3>checked</cfif> name="tab" value="3" onclick="submit()" id="tab3"><label for="tab3">Staff Setup</label></th>
							<th bgcolor=<cfif tab Is 4>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is 4>checked</cfif> name="tab" value="4" onclick="submit()" id="tab4"><label for="tab4">Plan Setup</label></th>
							<th bgcolor=<cfif tab Is 5>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is 5>checked</cfif> name="tab" value="5" onclick="submit()" id="tab5"><label for="tab5">State/Prov Setup</label></th>				
						</cfif>
					</form>
				</tr>
			</table>
