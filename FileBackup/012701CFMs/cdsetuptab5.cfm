...
<cfif IsDefined("AddRow.x")>
	...
	<tr>
		<form method="post" action="cdsetup.cfm">
			...
			<input type="hidden" name="UseTab" value="5">
...
<cfsetting enablecfoutputonly="No">
	<cfoutput>
		...
		<tr>
			<th bgcolor="#thclr#" colspan="7">Control 2</th>
		</tr>
		<tr>
			<th bgcolor="#thclr#">Start</th>
			<th bgcolor="#thclr#">End</th>
	...
	<form method="post" action="cdsetup.cfm">
		...
		<cfoutput query="alloptions">
			...
			<tr>
				...
				<cfif useyn is 1><td bgcolor="#tdclr#"><input type="text" name="endorder#count1#" value="#endorder#" size="3" maxlength="3"></td><cfelse><td bgcolor="#tdclr#"><input type="text" name="endorder#count1#" value="" size="3" maxlength="3"></td></cfif>
