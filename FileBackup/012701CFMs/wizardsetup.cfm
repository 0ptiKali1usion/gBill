			...
			<table border="1">
				<tr>
					<form method="post" action="wizardsetup.cfm">
						<td bgcolor=<cfif tab Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input <cfif tab Is 1>checked</cfif> type="radio" name="tab" value="1" onclick="submit()" id="tab1"><label for="tab1">Personal</label></td>
						<td bgcolor=<cfif tab Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input <cfif tab Is 2>checked</cfif> type="radio" name="tab" value="2" onclick="submit()" id="tab2"><label for="tab2">Support</label></td>
						<td bgcolor=<cfif tab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input <cfif tab Is 3>checked</cfif> type="radio" name="tab" value="3" onclick="submit()" id="tab3"><label for="tab3">Service</label></td>
						<td bgcolor=<cfif tab Is 4>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input <cfif tab Is 4>checked</cfif> type="radio" name="tab" value="4" onclick="submit()" id="tab4"><label for="tab4">Integration</label></td>
						<td bgcolor=<cfif tab Is 5>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input <cfif tab Is 5>checked</cfif> type="radio" name="tab" value="5" onclick="submit()" id="tab5"><label for="tab5">Financial</label></td>
					</form>
				</tr>
			</table>
		</th>
