				...
				<table border="1">
					<tr>
						<form method="post" action="intlocations.cfm">
							...
							<td bgcolor=<cfif Tab Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" name="tab" <cfif tab Is 1>checked</cfif> value="1" onclick="submit()" id="tab1"><label for="tab1">General</label></td>
							<td bgcolor=<cfif Tab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" name="tab" <cfif tab Is 3>checked</cfif> value="3" onclick="submit()" id="tab3"><label for="tab3">Scripts</label></td>
						</form>
					</tr>
				</table>
			</th>
