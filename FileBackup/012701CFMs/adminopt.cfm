...
<cfif IsDefined("SetIt.x")>
	<cfquery name="chkcolorset" datasource="#pds#">
		...
		ttSTab = '#form.ttSTab#', ttNTab = '#form.ttNTab#' 
	...
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="BOBHist" datasource="#pds#">
			...
			'#StaffMemberName.FirstName# #StaffMemberName.LastName# edited the settings for colors.')
		</cfquery>
	</cfif>
</cfif>
<cfif IsDefined("EditAppear.x")>
	...
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="BOBHist" datasource="#pds#">
			...
			VALUES 
			(Null,0,#MyAdminID#, #Now()#,'Edited Customer Info',
			'#StaffMemberName.FirstName# #StaffMemberName.LastName# edited the settings for page appearance.')
		</cfquery>
	</cfif>
</cfif>
<cfif IsDefined("enterit.x")>
	...
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="BOBHist" datasource="#pds#">
			...
			VALUES 
			(Null,0,#MyAdminID#, #Now()#,'Edited Customer Info',
			'#StaffMemberName.FirstName# #StaffMemberName.LastName# edited the settings for menu style.')
		</cfquery>
	</cfif>
				...
				<table border="1">
					<tr>
						<form method="post" action="adminopt.cfm">
							<td bgcolor=<cfif tab Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is "1">checked</cfif> name="tab" value="1" onclick="submit()" id="tab1"><label for="tab1">Menu Style</label></td>
							<td bgcolor=<cfif tab Is 4>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is "4">checked</cfif> name="tab" value="4" onclick="submit()" id="tab4"><label for="tab1">Page Appearance</label></td>
							<td bgcolor=<cfif tab Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is "2">checked</cfif> name="tab" value="2" onclick="submit()" id="tab2"><label for="tab1">Colors</label></td>
							<td bgcolor=<cfif tab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" <cfif tab Is "3">checked</cfif> name="tab" value="3" onclick="submit()" id="tab3"><label for="tab1">Sort Order</label></td>
						</form>
					</tr>
				</table>
			</th>
...
<cfelseif tab is "2">
	<cfoutput>
		...
		<form method="post" action="optcolor.cfm">
			...
			<tr>
				<td align="right" bgcolor="#tbclr#">Tab Selected Background Color</td>
				<td bgcolor="#ttSTab#">&nbsp;</td>
				<td bgcolor="#tdclr#"><INPUT type="text" name="ttSTab" value="#ttSTab#"></td>
			</tr>
			<tr>
				<td align="right" bgcolor="#tbclr#">Tab Not Selected Background Color</td>
				<td bgcolor="#ttNTab#">&nbsp;</td>
				<td bgcolor="#tdclr#"><INPUT type="text" name="ttNTab" value="#ttNTab#"></td>
			</tr>
			<tr>
	...
	<cfoutput query="GetPerLevels">
		...
		<Form method="post" action="adminopt.cfm">
			...
			<tr>
				...
				<cfif Count1 Is 1>
					<td bgcolor="#tdclr#"><img src="images/buttonhide.gif" border="0" width="20"><input type="image" src="images/buttong.gif" name="MvDn" border="0"></td>
				<cfelseif Count1 Is GetPerLevels.RecordCount>
					<td nowrap bgcolor="#tdclr#"><input type="image" src="images/buttonf.gif" name="MvUp" border="0"><img src="images/buttonhide.gif" border="0" width="20"></td>
				<cfelse>
