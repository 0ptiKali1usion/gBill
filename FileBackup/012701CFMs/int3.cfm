...
<table border="0">
	...
	<form method="post" action="integration2.cfm">
		...
		<tr valign="top">
			<td bgcolor="#tbclr#" align="RIGHT" nowrap>Use gBill Telnet</td>
			<td bgcolor="#tdclr#"><input <cfif OneScript.TelNetGTUseYN Is 1>checked</cfif> type="radio" name="TelNetGTUseYN" value="1"> Yes <input <cfif OneScript.TelNetGTUseYN Is 0>checked</cfif> type="radio" name="TelNetGTUseYN" value="0"> No</td>
			<td bgcolor="#tbclr#">&nbsp;</td>
			<td bgcolor="#tdclr#">&nbsp;</td>
		</tr>
		<tr valign="top">
			<td bgcolor="#tbclr#" align="RIGHT" nowrap>gBill Output File Path#OSType#Name</td>
			<td bgcolor="#tdclr#" colspan="3"><input type=text name="TelnetGTFileName" size="40" value="#OneScript.TelnetGTFileName#" maxlength="200"></td>
		</tr>
		<tr valign="top">
			<td bgcolor="#tbclr#" align="RIGHT" nowrap>gBill Install Path</td>
			<td bgcolor="#tdclr#" colspan="3"><input type=text name="TelnetGTPath" size="40" value="#OneScript.TelnetGTPath#" maxlength="200">gbill_tnet</td>
		</tr>
		<tr valign="top">
			<td bgcolor="#tbclr#" align="RIGHT" nowrap>Use Command Processor</td>
			<td bgcolor="#tdclr#"><input <cfif OneScript.UseCmdProcYN Is 1>checked</cfif> type="radio" name="UseCmdProcYN" value="1"> Yes <input <cfif OneScript.UseCmdProcYN Is 0>checked</cfif> type="radio" name="UseCmdProcYN" value="0"> No</td>
			<td bgcolor="#tbclr#">&nbsp;</td>
			<td bgcolor="#tdclr#">&nbsp;</td>
		</tr>
		<tr valign="top">
