...
<!--- 4.0.2 01/23/01 Added New button for Add New Account and Ability to display name, login or both.
		4.0.1 01/16/01 Fixed error with multiple pages.
		4.0.0 10/22/99 --->
<!--- group2.cfm --->
...
<cfparam name="HowToShowName" default="0">
<cfquery name="GetHowTo" datasource="#pds#">
	SELECT Value1 
	FROM Setup 
	WHERE VarName = 'HowToShowName'
</cfquery>
<cfif GetHowTo.RecordCount GT 0>
	<cfset HowToShowName = GetHowTo.Value1>
</cfif>
...
<cfquery name="GroupList" datasource="#pds#">
	SELECT A.Login, A.FirstName, A.LastName, A.AccountID, M.BillingID, M.BillTo, M.ViewPrivYN, 
...
<table border="#tblwidth#">	
	...
	<tr>
		<form method="post" action="group8.cfm">
			<td align="right" colspan="8"><input type="image" src="images/addnewaccnt.gif" name="AddNew" border="0"></td>
...
<form method="post" action="group2.cfm" name="EditInfo">
	...
	<cfoutput query="GroupList" startrow="#Srow#" maxrows="#Maxrows#">
		...
		<tr bgcolor="#tdclr#">
			...
			<td bgcolor="#tbclr#"><a href="custinf1.cfm?accountid=#accountid#" <cfif getopts.OpenNew Is 1>target="_new"</cfif> ><cfif HowToShowName Is 0>#LastName#, #FirstName#<cfelseif HowToShowName Is 1>#Login#<cfelseif HowToShowName Is 2>#LastName#, #FirstName# - #Login#<cfelse>#LastName#, #FirstName#</cfif></a></td>
