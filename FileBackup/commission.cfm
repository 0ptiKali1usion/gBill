		...
		<cftransaction>
			...
			<cfquery name="SalesDetails" datasource="#pds#">
				...
				<cfif SelectedSales Is Not 0>
					AND S.AdminID In (#SelectedSales#) 
				</cfif>
			</cfquery>
			<cfquery name="DomainDetails" datasource="#pds#">
				INSERT INTO CommCriteria 
				...
				<cfif SelectedDomains Is Not 0>
					WHERE DomainID In (#SelectedDomains#) 
				</cfif>
			</cfquery>
			<cfquery name="DetailsDetails" datasource="#pds#">
				...
				<cfif SelectedSales Is Not 0>
					AND U.SalesPersonID In (#SelectedSales#) 
				</cfif>
				<cfif SelectedPOPs Is Not 0>
					AND A.POPID In (#SelectedPOPs#) 
				</cfif>
				<cfif SelectedPlans Is Not 0>
					AND A.PlanID In (#SelectedPlans#) 
				</cfif>
