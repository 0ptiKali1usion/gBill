...
<table border="#tblwidth#">
	...
	<cfif OneP.CancelYN Is "1">
		<tr>
			<td colspan="2" bgcolor="#tbclr#">Cancelled: #LSDateFormat(OneP.CancelDate, '#datemask1#')#<br>#OneP.CancelReason#</td>
		</tr>
	<cfelseif (OneP.DeactivatedYN Is "1") AND (OneP.CancelYN Is "0")>
		<tr>
			<td colspan="2" bgcolor="#tbclr#">Deactivated: #LSDateFormat(OneP.DeactDate, '#datemask1#')#<br>#OneP.DeactReason#</td>
		</tr>
	</cfif>
</cfoutput>
...
<cfoutput>
		<td bgcolor="#tdclr#">
			<table border="0">
				...
				<cfif (GetOpts.ChPass Is "1") AND (OneP.CancelYN Is "0")>
					<tr>
