			...
			<table border="1">
				<form method="post" action="listplan2.cfm">
					...
					<tr>
						...
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 2>checked</cfif> name="tab" value="2" onclick="submit()" id="tab2"><label for="tab2">Financial</label></th>
						<cfelse>
							<th bgcolor="#thclr#">Financial</th>
						</cfif>
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 8>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 8>checked</cfif> name="tab" value="8" onclick="submit()" id="tab8"><label for="tab8">Domains</label></th>
						<cfelse>
							<th bgcolor="#thclr#">Domains</th>
						</cfif>
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 3>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 3>checked</cfif> name="tab" value="3" onclick="submit()" id="tab3"><label for="tab3">Integration</label></th>
						<cfelse>
							<th bgcolor="#thclr#">Integration</th>
						</cfif>
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 4>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 4>checked</cfif> name="tab" value="4" onclick="submit()" id="tab4"><label for="tab4">Metered</label></th>
						<cfelse>
							<th bgcolor="#thclr#">Metered</th>
						</cfif>
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 5>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 5>checked</cfif> name="tab" value="5" onclick="submit()" id="tab5"><label for="tab5">Staff</label></th>
						<cfelse>
							<th bgcolor="#thclr#">Staff</th>
						</cfif>
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 6>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 6>checked</cfif> name="tab" value="6" onclick="submit()" id="tab6"><label for="tab6">POP</label></th>
						<cfelse>
							<th bgcolor="#thclr#">POP</th>
						</cfif>
						<cfif PlanID GT 0>
							<th bgcolor=<cfif tab is 7>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 7>checked</cfif> name="tab" value="7" onclick="submit()" id="tab7"><label for="tab7">Scripts</label></th>
						<cfelse>
