			...
			<table border="1">
				<tr>
					<form method="post" action="batchhist2.cfm">
						...
						<th bgcolor=<cfif tab is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="Radio" <cfif tab Is 1>checked</cfif> name="tab" value="1" id="tab1" onclick="submit()"><label for="tab1">Output Info</label></th>
					</form>
					<form method="post" action="batchhist2.cfm">
						<input type="Hidden" name="BatchID" value="#BatchID#">
						<th bgcolor=<cfif tab is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="Radio" <cfif tab Is 2>checked</cfif> name="tab" value="2" id="tab2" onclick="submit()"><label for="tab2">Actual Output</label></th>
					</form>
				</tr>
			</table>
		</th>
