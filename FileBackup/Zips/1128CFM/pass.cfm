...
<form method="post" name="accounts" action="pass2.cfm">
	<cfif (GetOpts.ViewCPasswd Is 1) AND ((AdminCheck.Recordcount Is 0) OR (GetOpts.ViewAPasswd Is 1))>
		<cfoutput>
			...
			<tr bgcolor="#tbclr#">
				<th colspan="#tdclr#"><input type="checkbox" checked <cfif IsDefined("selectemall.x")>checked</cfif> name="gBillID" value="#AccountID#"></th>
...
<cfloop query="AllPlans">
	...
	<cfloop query="PlanAuths">
		<cfoutput>
			<tr bgcolor="#tbclr#">
				<th colspan="#tdclr#"><input type="checkbox" <cfif IsDefined("AuthIDList")><cfif ListFind(AuthIDList,AuthID) GT 0>checked</cfif></cfif><cfif IsDefined("selectemall.x")>checked</cfif> name="AuthID" value="#AuthID#"></th>
				<td>#UserName#</td>
				<cfif (GetOpts.ViewCPasswd Is 1) AND ((AdminCheck.Recordcount Is 0) OR (GetOpts.ViewAPasswd Is 1))>
					<td>#Password#</td>
				<cfelse>
	...
	<cfloop query="PlanFTPS">
		<cfoutput>
			<tr bgcolor="#tbclr#">
				<th colspan="#tdclr#"><input type="checkbox" <cfif IsDefined("FTPIDList")><cfif ListFind(FTPIDList,FTPID) GT 0>checked</cfif></cfif><cfif IsDefined("selectemall.x")>checked</cfif> name="FTPID" value="#FTPID#"></th>
				<td>#UserName#</td>
				<cfif (GetOpts.ViewCPasswd Is 1) AND ((AdminCheck.Recordcount Is 0) OR (GetOpts.ViewAPasswd Is 1))>
					<td>#Password#</td>
				<cfelse>
	...
	<cfloop query="PlanEMails">
		<cfoutput>
			<tr bgcolor="#tbclr#">
				<th colspan="#tdclr#"><input type="checkbox" <cfif IsDefined("EMailIDList")><cfif ListFind(EMailIDList,EMailID) GT 0>checked</cfif></cfif><cfif IsDefined("selectemall.x")>checked</cfif> name="EMailID" value="#EMailID#"></th>
				<td>#EMail#</td>
				<cfif (GetOpts.ViewCPasswd Is 1) AND ((AdminCheck.Recordcount Is 0) OR (GetOpts.ViewAPasswd Is 1))>
					<td>#EPass#</td>
				<cfelse>
