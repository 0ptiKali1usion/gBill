			...
			<table border="1">
				<tr bgcolor="#tdclr#">
					<form method="post" action="netsurfer.cfm">
						<td <cfif tab Is 2>bgcolor="#tbclr#"</cfif> ><input type="radio" <cfif tab Is 2>checked</cfif> name="tab" value="2" onclick="submit()" id="tab2"><label for="tab2">Plans</label></td>
						<td <cfif tab Is 3>bgcolor="#tbclr#"</cfif> ><input type="radio" <cfif tab Is 3>checked</cfif> name="tab" value="3" onclick="submit()" id="tab3"><label for="tab3">Payment</label></td>
						<td <cfif tab Is 1>bgcolor="#tbclr#"</cfif> ><input type="radio" <cfif tab Is 1>checked</cfif> name="tab" value="1" onclick="submit()" id="tab1"><label for="tab1">Sections</label></td>
						<td <cfif tab Is 4>bgcolor="#tbclr#"</cfif> ><input type="radio" <cfif tab Is 4>checked</cfif> name="tab" value="4" onclick="submit()" id="tab4"><label for="tab4">Custom Fields</label></td>
						<td <cfif tab Is 6>bgcolor="#tbclr#"</cfif> ><input type="radio" <cfif tab Is 6>checked</cfif> name="tab" value="6" onclick="submit()" id="tab6"><label for="tab6">Setup Values</label></td>
						<td <cfif tab Is 5>bgcolor="#tbclr#"</cfif> ><input type="radio" <cfif tab Is 5>checked</cfif> name="tab" value="5" onclick="submit()" id="tab5"><label for="tab5">Preview</label></td>
					</form>
				</tr>
			</table>		
		</th>
