...
<cfif IsDefined("FindStaff")>
		...
		<cfoutput query="FindStaff">
			<table border="#tblwidth#">			
				...
				<tr>
					...
					Click 'Add To List' to add to the Auto Deactivation List.</th>
				</tr>
				<tr>
	...
	<cfelseif FindStaff.RecordCount GT 1>
		<table border="#tblwidth#">			
			<cfoutput>
				<tr>
					<th bgcolor="#ttclr#" colspan="4"><font size="#ttsize#" <cfif ttface Is Not "NA">face="#ttface#"</cfif> color="#ttfont#">Search Results</font></th>
				</tr>
				<tr>
					<Th bgcolor="#thclr#">Name</th>
					<th bgcolor="#thclr#">gBill Login</th>
					<th bgcolor="#thclr#">Phone</th>
					<th bgcolor="#thclr#">City</th>
				</tr>
			</cfoutput>
			<cfoutput Query="FindStaff">
				<TR valign="top">
					<TD bgcolor="#tbclr#"><A HREF="autodeact2.cfm?AccountID=#AccountID#">#lastname#, #firstname#</a></td>
					<td bgcolor="#tbclr#">#login#</td>
					<td bgcolor="#tbclr#">#dayphone#</td>
