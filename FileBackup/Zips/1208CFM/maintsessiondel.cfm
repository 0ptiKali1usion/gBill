...
<cfif GetValue.Value1 Is Not "">
	<cfset DateMask1 = GetValue.Value1>
</cfif>
		...
		<cfif (ODBCName Is Not "") AND (TableName Is Not "") 
		 AND (CallDateName Is Not "") AND (UserNameField Is Not "")>
			...
			<cfquery name="BOBHist" datasource="#pds#">
				...
				VALUES 
				(#AccountID#, 0, #Now()#, 'gBill Automatic','#Username# session history older than #DateFormat(Date1 ,'#DateMask1#')# was deleted.')
			</cfquery>
