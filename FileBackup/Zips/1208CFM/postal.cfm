...
<table border="#tblwidth#">
	<tr>
		<th bgcolor="#ttclr#" colspan="2"><font size="#ttsize#" <cfif ttface Is Not "NA">face="#ttface#"</cfif> color="#ttfont#">Postal Statement Customers</font></th>
	</tr>
</cfoutput>
<cfif CheckFirst.Recordcount GT 0>
	<cfoutput>
		<tr>
			<td colspan="2" bgcolor="#tbclr#">There is already a Postal Statement Customer List.</td>
		</tr>
		<tr>	
			<form method="post" action="grplist.cfm">
				...
				<th><input type="image" src="images/viewlist.gif" border="0" name="ViewExisting"></th>
			</form>
			<form method="post" action="postal.cfm">
				<th><input type="image" src="images/changecriteria.gif" border="0" name="StartOver"></th>
			</form>
		</tr>
	</cfoutput>
<cfelse>
