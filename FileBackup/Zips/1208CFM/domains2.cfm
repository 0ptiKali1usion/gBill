...
<cfif IsDefined("AddNewDomain.x")>
	<cftransaction>
		...
		<cfif CheckFirst.RecordCount Is 0>
			<cfquery name="addadom" datasource="#pds#">
				...
				VALUES 
				('#DomainName#', #showyn#, #privateYN#, #useaddr#, 
	...
	<cfif Not IsDefined("NoBOBHist")>
		...
		<cfquery name="BOBHist" datasource="#pds#">
			...
			VALUES 
			(Null,0,#MyAdminID#, #Now()#,'Domain','#StaffMemberName.FirstName# #StaffMemberName.LastName# added the domain #GetDom.DomainName#.')
		</cfquery>
	</cfif>
				...
				<table border="1">
					<tr>
						<form method="post" action="domains2.cfm">
							...
							<input type="hidden" name="Orddir" value="#Orddir#">
							<input type="hidden" name="Ordby" value="#Ordby#">
							<td bgcolor=<cfif Tab Is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 1>checked</cfif> name="tab" value="1" onClick="submit()" id="tab1"><label for="tab1">General</label></td>
							<cfif OneDomain.RecordCount GT 0>
								<td bgcolor=<cfif Tab Is 5>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 5>checked</cfif> name="tab" value="5" onClick="submit()" id="tab5"><label for="tab5">Integration</label></td>
								<td bgcolor=<cfif Tab Is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 2>checked</cfif> name="tab" value="2" onClick="submit()" id="tab2"><label for="tab2">Plans</label></td>
								...
								<td bgcolor=<cfif Tab Is 4>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" <cfif tab Is 4>checked</cfif> name="tab" value="4" onClick="submit()" id="tab4"><label for="tab4">Users</label></td>
							<cfelse>
