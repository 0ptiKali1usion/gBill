		...
		<cfloop query="GetRow">
				...
				<cfelseif BOBFieldName Is "POPID">
					<cfquery name="AvailPops" datasource="#pds#">
						SELECT P.POPID, P.POPName, P.DataAreaCode, P.PhoneData  
					...
					<cfoutput query="AvailPOPS">
						<option value="#POPID#">#POPName# - (#DataAreaCode# #PhoneData#)
					</cfoutput>
					</select></td>
					<cfif InputRequired Is 1>
						<cfoutput>
...
--->
					...
					<cfoutput>
						<tr bgcolor="#tbclr#" valign="top">
							...
							<input type="hidden" name="BOBLogin_Required" value="Please enter the login to be used for IBOB.">
						</tr>
						<tr valign="top" bgcolor="#tbclr#">
							...
							<input type="hidden" name="BOBPassword_Required" value="Please enter the password to be used for IBOB.">
						</tr>
					</cfoutput>
				...
				<cfelseif BOBFieldName Is "postalinv">
					...
					<cfif OfferPost GT 0>
						...
						<cfif SignUpInfo.PostalInv Is Not "">
				...
				<cfelse>
					<cfoutput>
						...
						<cfif (InputSize LT 999) AND (InputSize GT 0)>
