		...
		<cftransaction>
			<cfquery name="InsTrans" datasource="#pds#">
				...
				(#AccountID#, #Now()#, #AmntAmount#, 0, 1, '#StaffMemberName.FirstName# #StaffMemberName.LastName#', 0, Null, Null, 
				 Null, 0, #AccountID#, 0, 0, 0, 0, Null, #DeactInfo.SalesPersonID#, Null, #AmntAmount#, 0 , Null, Null, Null, 0, 
	...
	<cfelseif DeactWhen Is "Later">
		...
		<cfif CancelYN Is 0>
			<cfquery name="ScheduleTheEvents" datasource="#pds#">
				...
				VALUES 
				('#MemoReason#', #WhenRun#, 'Cancel', #AccountID#, 0, 0, '#StaffMemberName.FirstName# #StaffMemberName.LastName#', #BillMethod#)
			</cfquery>	
