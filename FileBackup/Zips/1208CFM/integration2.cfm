					...
					<cfoutput>
						<cfif IntTypeSetup Is "Letter">
							...
							<form method="post" action="integration2.cfm">
								...
								<td bgcolor=<cfif tab Is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 1>checked</cfif> value="1" onclick="submit()" id="tab1"><label for="tab1">General</label><cfelse>General</cfif></td>
								<td bgcolor=<cfif tab Is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 2>checked</cfif> value="2" onclick="submit()" id="tab2"><label for="tab2">Custom Variables</label><cfelse>Custom Variables</cfif></td>
								<td bgcolor=<cfif tab Is 9>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 9>checked</cfif> value="9" onclick="submit()" id="tab9"><label for="tab9">EMail</label><cfelse>EMail</cfif></td>
								<td bgcolor=<cfif tab Is 13>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 13>checked</cfif> value="13" onclick="submit()" id="tab13"><label for="tab13">Staff</label><cfelse>Staff</cfif></td>
							</form>
						<cfelse>
							<cfset Tab2Layout = "NonLetter">
							<form method="post" action="integration2.cfm">
								<input type="hidden" name="IntID" value="#IntID#">
								<td bgcolor=<cfif tab Is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><input type="radio" name="tab" <cfif tab Is 1>checked</cfif> value="1" onclick="submit()" id="tab1"><label for="tab1"><font size="2">General</font></label></td>
								<td bgcolor=<cfif tab Is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 2>checked</cfif> value="2" onclick="submit()" id="tab2"><label for="tab2"><font size="2">Custom</font></label><cfelse><font size="2">Custom</font></cfif></td>
								<td bgcolor=<cfif tab Is 3>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 3>checked</cfif> value="3" onclick="submit()" id="tab3"><label for="tab3"><font size="2">Telnet</font></label><cfelse><font size="2">Telnet</font></cfif></td>
								<td bgcolor=<cfif tab Is 4>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 4>checked</cfif> value="4" onclick="submit()" id="tab4"><label for="tab4"><font size="2">Batch</font></label><cfelse><font size="2">Batch</font></cfif></td>
								<td bgcolor=<cfif tab Is 5>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 5>checked</cfif> value="5" onclick="submit()" id="tab5"><label for="tab5"><font size="2">URL</font></label><cfelse><font size="2">URL</font></cfif></td>
								<td bgcolor=<cfif tab Is 6>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 6>checked</cfif> value="6" onclick="submit()" id="tab6"><label for="tab6"><font size="2">CFM</font></label><cfelse><font size="2">CFM</font></cfif></td>
								<td bgcolor=<cfif tab Is 7>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 7>checked</cfif> value="7" onclick="submit()" id="tab7"><label for="tab7"><font size="2">FTP</font></label><cfelse><font size="2">FTP</font></cfif></td>
								<td bgcolor=<cfif tab Is 8>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 8>checked</cfif> value="8" onclick="submit()" id="tab8"><label for="tab8"><font size="2">SQL</font></label><cfelse><font size="2">SQL</font></cfif></td>
								<td bgcolor=<cfif tab Is 9>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 9>checked</cfif> value="9" onclick="submit()" id="tab9"><label for="tab9"><font size="2">EMail</font></label><cfelse><font size="2">EMail</font></cfif></td>
								<td bgcolor=<cfif tab Is 10>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 10>checked</cfif> value="10" onclick="submit()" id="tab10"><label for="tab10"><font size="2">Order</font></label><cfelse><font size="2">Order</font></cfif></td>
								<td bgcolor=<cfif tab Is 11>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 11>checked</cfif> value="11" onclick="submit()" id="tab11"><label for="tab11"><font size="2">Plans</font></label><cfelse><font size="2">Plans</font></cfif></td>
								<td bgcolor=<cfif tab Is 12>"#tbclr#"<cfelse>"#tdclr#"</cfif> nowrap><cfif IntID gt 0><input type="radio" name="tab" <cfif tab Is 12>checked</cfif> value="12" onclick="submit()" id="tab12"><label for="tab12"><font size="2">Locations</font></label><cfelse><font size="2">Locations</font></cfif></td>
							</form>
						</cfif>
					</cfoutput>
				</tr>
