...
<cfparam name="BODBCType" default="access">
<cfparam name="DateMask1" default="MMM/DD/YY">
...
<cfparam name="SendEMail" default="1">
...
<cfif gsdebug is 0>
	...
	<cfif IsDefined("cookie.MyAdminID")>
		...
		<cfparam name="ttNTab" default="#GetOpts.thclr#">
