			...
			<table border="1">
				<tr>
					<form method="post" action="cdsetup.cfm">
						<th bgcolor=<cfif tab is 6>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" name="tab" <cfif tab Is 6>checked</cfif> value="6" onclick="submit()" id="tab6"><label for="tab6">General</label></th>
						<th bgcolor=<cfif tab is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" name="tab" <cfif tab Is 1>checked</cfif> value="1" onclick="submit()" id="tab1"><label for="tab1">Header</label></th>
						<th bgcolor=<cfif tab is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" name="tab" <cfif tab Is 2>checked</cfif> value="2" onclick="submit()" id="tab2"><label for="tab2">Header 2</label></th>
						<th bgcolor=<cfif tab is 3>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" name="tab" <cfif tab Is 3>checked</cfif> value="3" onclick="submit()" id="tab3"><label for="tab3">Detail</label></th>
						<th bgcolor=<cfif tab is 4>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" name="tab" <cfif tab Is 4>checked</cfif> value="4" onclick="submit()" id="tab4"><label for="tab4">Control</label></th>
						<th bgcolor=<cfif tab is 5>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input type="radio" name="tab" <cfif tab Is 5>checked</cfif> value="5" onclick="submit()" id="tab5"><label for="tab5">Control 2</label></th>
					</form>
				</tr>
			</table>
		</th>
