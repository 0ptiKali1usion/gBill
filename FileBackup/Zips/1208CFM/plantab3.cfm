	...
	<tr valign="top" bgcolor="#tdclr#">
		...
		<td><select name="DefAuthServer">
			<cfloop query="DefAuth">
				<cfoutput><option <cfif OnePlan.DefAuthServer Is DomainName>selected</cfif> value="#DomainName#">#DomainName# - #AuthServer#</cfoutput>
			</cfloop>
		</select></td>
	</tr>
	<cfoutput>
...
<cfoutput>
	...
	<tr valign="top">
		...
		<td bgcolor="#tdclr#"><input value="#kblimit#" type="text" name="MailBoxLimit" size="5" maxlength="10"> Bytes</td>
	<tr valign="top" bgcolor="#tdclr#">
		...
		<td><select name="DefMailServer">
			<cfloop query="DefEMail">
				<cfoutput><option <cfif OnePlan.DefMailServer Is DomainName>selected</cfif> value="#DomainName#">#DomainName# - #POP3Server#</cfoutput>
			</cfloop>
		</select></td>
	</tr>
<cfoutput>
...
<cfoutput>
	...
	<tr valign="top" bgcolor="#tdclr#">
		...
		<td><select name="DefFTPServer">
			<cfloop query="DefFTP">
				<cfoutput><option <cfif OnePlan.DefFTPServer Is DomainName>selected</cfif> value="#DomainName#">#DomainName# - #FTPServer#</cfoutput>
			</cfloop>
		</select></td>
	</tr>
	<cfoutput>
