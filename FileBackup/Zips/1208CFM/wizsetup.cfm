		...
		<tr>
			<th colspan="#HowWide#">
				<table border="1">
					<tr>
						<form method="post" action="wizsetup.cfm">
							<td bgcolor=<cfif tab is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab Is 1>checked</cfif> type="radio" name="tab" value="1" onclick="submit()" id="tab1"><label for="tab1">Modem Speeds</label></td>
							<td bgcolor=<cfif tab is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab Is 2>checked</cfif> type="radio" name="tab" value="2" onclick="submit()" id="tab2"><label for="tab2">Op Sys Version</label></td>
							<td bgcolor=<cfif tab is 3>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab Is 3>checked</cfif> type="radio" name="tab" value="3" onclick="submit()" id="tab3"><label for="tab3">State/Provs</label></td>
							<td bgcolor=<cfif tab is 5>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab Is 5>checked</cfif> type="radio" name="tab" value="5" onclick="submit()" id="tab5"><label for="tab5">Countries</label></td>
							<td bgcolor=<cfif tab is 4>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab Is 4>checked</cfif> type="radio" name="tab" value="4" onclick="submit()" id="tab4"><label for="tab4">Pay Types</label></td>
						</form>
					</tr>
				</table>
			</th>
					...
					<table border="1">
						<tr>
							<form method="post" action="wizsetup.cfm">
								...
								<td bgcolor=<cfif tab2 Is 4>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab2 Is 4>checked</cfif> type="radio" name="tab2" value="4" onclick="submit()" id="tabA1"><label for="tabA1">Check/ Cash</label></td>
								<td bgcolor=<cfif tab2 Is 1>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab2 Is 1>checked</cfif> type="radio" name="tab2" value="1" onclick="submit()" id="tabA2"><label for="tabA2">Check Debit</label></td>
								<td bgcolor=<cfif tab2 Is 2>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab2 Is 2>checked</cfif> type="radio" name="tab2" value="2" onclick="submit()" id="tabA3"><label for="tabA3">Credit Card</td>
								<td bgcolor=<cfif tab2 Is 3>"#tbclr#"<cfelse>"#tdclr#"</cfif> ><input <cfif tab2 Is 3>checked</cfif> type="radio" name="tab2" value="3" onclick="submit()" id="tabA4"><label for="tabA4">PO</td>
							</form>
						</tr>
					</table>
				</th>
