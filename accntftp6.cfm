			...
			<cfif CheckFirst.Recordcount Is 0>
				...
				<cftransaction>
					<cfquery name="BOBAuth" datasource="#pds#">
						...
						AccountID, AccntPlanID, CFTPID, FTPServer, FTPSizeLimit) 
						VALUES 
						...
						<cfloop query="GetFDValues">
						 ...
						 #GetInfo.AccountID#, #AccntPlanID#, #GetDomain.CFTPID#, '#GetDomain.FTPServer#', #FTPSizeLimit#)
					</cfquery>
...
<cfelse>
	...
	<form method="post" action="accntftp6.cfm">
		<cfoutput>
			...
			<tr bgcolor="#tbclr#" valign="top">
				<td align="right">Size Limit</td>
				<cfif IsDefined("FTPSizeLimit")>
					<cfset FTPSizeLimit = Evaluate("FTPSizeLimit")>
				<cfelse>
					<cfset FTPSizeLimit = "">
				</cfif>
				<td bgcolor="#tdclr#"><input type="text" name="FTPSizeLimit" value="#FTPSizeLimit#" maxlength="3"></td>
			</tr>
			<tr>
				<td bgcolor="#tbclr#" colspan="2"><font size="2">Limit the size of the site to however many MB</font></td>
			</tr>
		</cfoutput>
		<cfloop query="GetFdValues">
