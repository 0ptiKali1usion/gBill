...
<cfif CheckFirst.RecordCount Is 0>
	...
	<cfif ListLen(CriteriaToSearch) GT 0>
		...
		<cfloop index="B4" list="#CriteriaToSearch#">
			...
			<cfelseif FName Is "Status">
				<cfoutput>
				<td bgcolor="#tdclr#" align="right">Status <select name="#FName#">
				</cfoutput>
				<cfoutput><option selected value="0">All
						  <option value="1">Completed
						  <option value="2">Pending
						  <option value="3">Escalated</td>
						  </select>
				</cfoutput>
			<cfelseif FName Is "Type">
				<cfoutput>
				<td bgcolor="#tdclr#" align="right">Type <select name="#FName#">
				</cfoutput>
				<cfoutput><option selected value="0">All
						  <option value="1">Tech: General
						  <option value="2">Tech: Lead
						  <option value="3">Tech: DSL
						  <option value="4">Sales: General
						  <option value="5">Sales: Admin
						  <option value="6">Sales: DSL
						  <option value="7">Sales: Development
						  <option value="8">Operations
						  <option value="9">Billing
						  <option value="10">QC
						  </select>
						  </td>
				</cfoutput>
