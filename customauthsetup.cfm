...
<cfif IsDefined("SetDefault")>
	...
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="GetOldAuth" datasource="#pds#">
	...
	<!--- BOB History --->
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="GetNewAuth" datasource="#pds#">
			SELECT AuthDescription 
			FROM CustomAuth 
			WHERE DefaultYN = 1 
		</cfquery>
		<cfquery name="BOBHist" datasource="#pds#">
			...
			'#StaffMemberName.FirstName# #StaffMemberName.LastName# changed the default auth from #GetOldAuth.AuthDescription# to #GetNewAuth.AuthDescription#.')
		</cfquery>
	</cfif>
</cfif>
	...
	<cftransaction>
		...
		<cfif Not IsDefined("NoBOBHist")>
			...
			<cfquery name="BOBHist" datasource="#pds#">
				...
				VALUES 
				(Null,0,#MyAdminID#, #Now()#,'System',
				'#StaffMemberName.FirstName# #StaffMemberName.LastName# deleted #GetAuth.AuthDescription# from the custom auth setup.')
			</cfquery>
		</cfif>
		...
		<cftransaction>
			...
			<cfif Not IsDefined("NoBOBHist")>
				<cfquery name="BOBHist" datasource="#pds#">
					...
					VALUES 
					(Null,0,#MyAdminID#, #Now()#,'System',
					'#StaffMemberName.FirstName# #StaffMemberName.LastName# added #AuthDescription# to the custom auth setup.')
				</cfquery>
			</cfif>
		</cftransaction>
