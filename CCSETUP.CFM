	...
	<cfif tab LTE 8>
		<tr>
			<th colspan="#HowWide#">
				<table border="1">
					<form method="post" action="ccsetup.cfm">
						<th bgcolor=<cfif tab2 Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif>><input <cfif tab2 Is 1>checked</cfif> type="radio" name="tab2" value="1" onclick="submit()" id="tab1"><label for="tab1">Batch Export</label></th>
						<th bgcolor=<cfif tab2 Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif>><input <cfif tab2 Is 2>checked</cfif> type="radio" name="tab2" value="2" onclick="submit()" id="tab2"><label for="tab2">Batch Import</label></th>
						<th bgcolor=<cfif tab2 Is 4>"#ttSTab#"<cfelse>"#ttNTab#"</cfif>><input <cfif tab2 Is 4>checked</cfif> type="radio" name="tab2" value="4" onclick="submit()" id="tab4"><label for="tab4">Live Debit</label></th>
					</form>
				</table>		
			</th>
		</tr>
				...
				<th colspan="#HowWide#">
					<table border="1">
						<form method="post" action="ccsetup.cfm">
							...
							<td bgcolor=<cfif tab Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif>><input <cfif tab Is 1>checked</cfif> type="radio" name="tab" value="1" onclick="submit()" id="tab1-1"><label for="tab1-1">General</label></td>
							<td bgcolor=<cfif tab Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif>><input <cfif tab Is 2>checked</cfif> type="radio" name="tab" value="2" onclick="submit()" id="tab1-2"><label for="tab1-2">Sale</label></td>
							<td bgcolor=<cfif tab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif>><input <cfif tab Is 3>checked</cfif> type="radio" name="tab" value="3" onclick="submit()" id="tab1-3"><label for="tab1-3">Refund</label></td>
						</form>
					</table>
				</th>
			</tr>
		...
		<tr>
			<th colspan="#HowWide#">					
				<table border="1">
					<tr>
						<form method="post" action="ccsetup.cfm">
							<th bgcolor=<cfif FormTab Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="Radio" <cfif FormTab Is 1>checked</cfif> name="FormTab" value="1" onclick="submit()" id="Tab1"><label for="Tab1">General</label></th>
							<th bgcolor=<cfif FormTab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="Radio" <cfif FormTab Is 3>checked</cfif> name="FormTab" value="3" onclick="submit()" id="Tab3"><label for="Tab3">Codes</label></th>
							<cfif CCCompSel Is "FormBased">
								<th bgcolor=<cfif FormTab Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="Radio" <cfif FormTab Is 2>checked</cfif> name="FormTab" value="2" onclick="submit()" id="Tab2"><label for="Tab2">Form Fields</label></th>
							</cfif>
							<input type="Hidden" name="Tab2" value="4">
						</form>
					</tr>
...
<cfif (Tab2 Is 4) AND (FormTab Is 1)>
					...
					<cfif ShowButton Is 1>
						...
						<form method="post" action="ccsetup.cfm">
							<cfoutput>
								...
								<input type="Hidden" name="CCLD" value="1">
					...
					<cfif ShowButton Is 1>
						...
						<form method="post" action="ccsetup.cfm">
							<cfoutput>
								<input type="hidden" name="TheCode" value="#TheCode#">
								<input type="Hidden" name="TheDisp" value="#TheDisp#">
								<input type="Hidden" name="CCB" value="1">
								<td><input type="submit" name="SetGeneric" value="#TheDisp#"></td>
								<input type="Hidden" name="tab2" value="#tab2#">
								<input type="Hidden" name="tab" value="#tab#">
							</cfoutput>
