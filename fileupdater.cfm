...
<cfif Not IsDefined("IAgree")>
	...
	<table border="#tblwidth#">
		...
		<tr>
			<th align="left" colspan="2" bgcolor="White"><font size="5" color="Red">WARNING:  If you have modified any files and you use the file updater to update that file your changes will be lost.<br>
			Please make backups of any files that you have modified.</font></th>
		</tr>
		<tr>
