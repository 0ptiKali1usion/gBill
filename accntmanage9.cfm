...
<cfif IsDefined("AllDone.x")>
	...
	<cfif SchedWhen Is "Now">
		<cf_cfcancelaccnt AccountID="#AccountID#" AccntPlanID="#AccntPlanID#" DeleteHist="1" 
		 ScheduledBy="#StaffMemberName.FirstName# #StaffMemberName.LastName#" IntLocation="accntmanage9.cfm" 
		 CancelReason="#dreason#">
	<cfelse>
		<cfquery name="SchedChange" datasource="#pds#">
			...
			('Cancel', #CreateODBCDateTime(SchedDT)#, #AccountID#, #AccntPlanID#, #DelAccount#, 
			 '#StaffMemberName.FirstName# #StaffMemberName.LastName#', '#DReason#', 
			 'Plan scheduled to change from #CurPlan.PlanDesc# to cancel on #LSDateFormat(SchedDT, '#Datemask1#')#.')
		</cfquery>
