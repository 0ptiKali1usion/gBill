...
<cfif IsDefined("AdjEnter.x")>
	...
	<cfif Not IsDefined("NoBOBHist")>
		...
		<cfif AdjType Is "Credit">
			<cfset HistMessage = "#StaffMemberName.FirstName# #StaffMemberName.LastName# entered a credit of #LSCurrencyFormat(AdjAmount)# for #PersonalInfo.FirstName# #PersonalInfo.LastName#.">
		<cfelse>
			<cfset HistMessage = "#StaffMemberName.FirstName# #StaffMemberName.LastName# entered a charge of #LSCurrencyFormat(AdjAmount)# for #PersonalInfo.FirstName# #PersonalInfo.LastName#.">
		</cfif>
		<cfif IsDefined("AdjReason")>
			<cfif Trim(AdjReason) Is Not "">
				<cfset HistMessage = HistMessage & "  #AdjReason#">
			</cfif>
		</cfif>
		<cfquery name="BOBHist" datasource="#pds#">
			...
			VALUES 
			(Null,#AccountID#,#MyAdminID#, #Now()#,'Edited Customer Info','#HistMessage#')
		</cfquery>
	</cfif>
