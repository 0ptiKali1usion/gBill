...
<cfif IsDefined("SetDefault")>
	...
	<cfif Not IsDefined("NoBOBHist")>
		<cfquery name="GetOldMail" datasource="#pds#">
	...
	<cfif Not IsDefined("NoBOBHist")>
		...
		<cfquery name="BOBHist" datasource="#pds#">
			...
			'#StaffMemberName.FirstName# #StaffMemberName.LastName# changed the default EMail from #GetOldMail.EMailDescription# to #GetNewMail.EMailDescription#.')
		</cfquery>
	</cfif>
</cfif>
<cfif IsDefined("DelSel.x")>
	<cftransaction>
		<!--- BOB History --->
		<cfif Not IsDefined("NoBOBHist")>
			<cfquery name="GetMail" datasource="#pds#">
				SELECT EMailDescription 
				FROM CustomEMail 
			...
			<cfquery name="BOBHist" datasource="#pds#">
				...
				VALUES 
				(Null,0,#MyAdminID#, #Now()#,'System',
				'#StaffMemberName.FirstName# #StaffMemberName.LastName# deleted #GetMail.EMailDescription# from the custom EMail setup.')
			</cfquery>
		</cfif>
	...
	<cftransaction>
		...
		<cfif Not IsDefined("NoBOBHist")>
			<cfquery name="BOBHist" datasource="#pds#">
				...
				VALUES 
				(Null,0,#MyAdminID#, #Now()#,'System',
				'#StaffMemberName.FirstName# #StaffMemberName.LastName# added #EMailDescription# to the custom EMail setup.')
			</cfquery>
		</cfif>
	</cftransaction>
