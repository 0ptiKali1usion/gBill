				...
				<table border="1">
					<tr>
						<form method="post" action="message2.cfm">
							<th bgcolor=<cfif Tab Is 1>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" name="Tab" <cfif Tab Is 1>checked</cfif> value="1" onclick="submit()" id="Tab1"><label for="Tab1">Message</label></th>
							<th bgcolor=<cfif Tab Is 2>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" name="Tab" <cfif Tab Is 2>checked</cfif> value="2" onclick="submit()" id="Tab2"><label for="Tab2">Staff</label></th>
							<cfif (SelectMessage.DisplayCode Is 2)>
								<th bgcolor=<cfif Tab Is 3>"#ttSTab#"<cfelse>"#ttNTab#"</cfif> ><input type="radio" name="Tab" <cfif Tab Is 3>checked</cfif> value="3" onclick="submit()" id="Tab3"><label for="Tab3">Acknowledge</label></th>
							</cfif>
